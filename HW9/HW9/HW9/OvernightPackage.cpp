...
OvernightPackage::OvernightPackage(char *snamevalue, char *saddressvalue, char* scityvalue, char* sstatevalue, char *szipvalue, char* rnamevalue, char *raddressvalue, char* rcityvalue, char* rstatevalue, char *rzipvalue, double weightvalue, double basiccostvalue, double flatfeevalue) 
...
//set flat fee
void OvernightPackage::setflatfee(double flatfeevalue)
{
	if (flatfeevalue > 0)
	{
