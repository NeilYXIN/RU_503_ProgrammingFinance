...
// Example: Homework 3 using matrices
// Submitting date: Oct/6/2017

#include<iostream>
using namespace std;

void input(int *row, int *col, float matrix[10][10])
{
...
void display(float matrix[10][10], int *row, int *col) 
{
	for (int i = 0; i < *row; i++)
	{
		for (int j = 0; j < *col; j++)
...
void addition(int *row1,int *row2,int *col1,int *col2,int *rowr,int *colr,float matrix1[10][10],float matrix2[10][10],float mres[10][10])
{
...
void subtraction(int *row1, int *row2, int *col1, int *col2, int *rowr, int *colr, float matrix1[10][10], float matrix2[10][10], float mres[10][10])
{
...
void multiplication(int *row1, int *row2, int *col1, int *col2, int *rowr, int *colr, float matrix1[10][10], float matrix2[10][10], float mres[10][10])
{
...
void transpose(int *row1, int *col1, int *rowr, int *colr, float matrix1[10][10], float mres[10][10])
{
	*rowr = *col1;
	*colr = *row1;
	for (int i = 0; i < *rowr; i++)
...
void determinant(int *row1, int *col1, float matrix1[10][10], float *det)
{
	if (*row1!= 3 || *col1!= 3)
	{
		cout << "The operation is not supported!" << endl << endl;
...
void inverse(int *row1, int *col1, int *rowr, int *colr, float matrix1[10][10], float mres[10][10])
{
	float det = -1;
